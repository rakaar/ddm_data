...
print(f"
Number of abort rows removed by dropna: {removed_abort_rows} ({removed_abort_rows/len(abort_rows_before)*100:.2f}%)")
...
print(f"Removed abort rows where previous trial was also abort: {removed_abort_followed_by_abort} ({removed_abort_followed_by_abort/abort_followed_by_abort_before*100:.2f}% of such rows)")
