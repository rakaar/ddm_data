...
# We'll create 'rewarded' from 'success' and 'is_abort' is created from 'abort_event'
lagged_vars = ['rewarded', 'is_abort', 'short_poke', 'intended_fix', 'ILD', 'ABL', 'TotalFixTime', 'CNPTime']

# We'll create short_poke as defined in glm_all_T.py
...
plt.tight_layout()
plt.savefig('correlation_matrices_fixed.png', dpi=300, bbox_inches='tight')
...
plt.tight_layout()
plt.savefig('weighted_correlation_matrix_fixed.png', dpi=300, bbox_inches='tight')
...
if vif_results:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('average_vif_fixed.png', dpi=300, bbox_inches='tight')
