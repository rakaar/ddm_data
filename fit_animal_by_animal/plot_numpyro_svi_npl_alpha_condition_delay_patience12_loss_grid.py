# %%
"""
Plot all-animal loss curves for the patience12 restore-best NPL+alpha SVI rerun.
...
sampling, and the red dashed line is the final step checked before the rule
stopped.
"""
...
OUTPUT_ROOT = Path(
    os.environ.get(
        "NUMPYRO_SVI_PATIENCE12_OUTPUT_ROOT",
...
FIG_PATH = SUMMARY_DIR / "npl_alpha_condition_delay_patience12_loss_grid.png"
SUMMARY_CSV = SUMMARY_DIR / "npl_alpha_condition_delay_patience12_loss_grid_summary.csv"
...
print("Loaded completed patience12 NPL+alpha condition-delay SVI runs:")
...
fig.suptitle(
    "Patience12 restore-best NPL+alpha condition-delay SVI loss curves",
    y=0.995,
    fontsize=14,
)
