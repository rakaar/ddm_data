...
OUTPUT_DIR = '/home/rlab/raghavendra/ddm_data/fit_animal_by_animal/crsy_25_figs_new/fig2/'
...
def save_individual_figure(filename_prefix):
    """Save current figure in all required formats."""
    formats = {
        'pdf': {'format': 'pdf'},
        'eps': {'format': 'eps'},
        'svg': {'format': 'svg'},
    ...
    for ext, kwargs in formats.items():
        ...
        plt.savefig(filepath, bbox_inches='tight', facecolor='white', **kwargs)
        print(f"Saved: {filepath}")

print("\nCreating and saving individual subfigures...")

# 1. Psychometric curves
print("\n1. Psychometric curves:")
fig1, ax1 = plt.subplots(figsize=(6, 5))
plot_psychometric(ax1, psy_data)
plt.tight_layout()
save_individual_figure('fig2a_psychometric')
plt.close()

# 2. RT Quantiles
print("\n2. RT Quantiles:")
fig2, ax2 = plt.subplots(figsize=(6, 5))
plot_quantiles(ax2, quant_data)
plt.tight_layout()
save_individual_figure('fig2b_rt_quantiles')
plt.close()

# 3. Slopes scatter
print("\n3. Slopes scatter:")
fig3, ax3 = plt.subplots(figsize=(6, 5))
plot_slopes(ax3, slopes_data)
plt.tight_layout()
save_individual_figure('fig2c_slopes_scatter')
plt.close()

# 4. Gamma curves
print("\n4. Gamma curves:")
fig4, ax4 = plt.subplots(figsize=(6, 5))
plot_gamma(ax4, gamma_data)
plt.tight_layout()
save_individual_figure('fig2d_gamma')
plt.close()

print("\n" + "="*60)
print(f"All subfigures saved to: {OUTPUT_DIR}")
...
print("Combined figure saved: fig2_final_figure.png")
