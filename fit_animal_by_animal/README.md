...
- `figure4_mse_npl_params_patience12_big_svi.py` - Builds a 2 x 3 Figure 4-style diagnostic using per-animal MSE-fit NPL+alpha parameters with `w`, `del_go`, and condition-wise `t_E_aff` from the all-30 patience12 big Gamma/Omega/delay SVI fit; includes psychometric, slopes, all-decile continuous/discrete RT quantiles, and paper-style 10/30/50/70/90 quantile versions.
