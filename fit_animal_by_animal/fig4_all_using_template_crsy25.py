...
OUTPUT_DIR = '/home/rlab/raghavendra/ddm_data/fit_animal_by_animal/crsy_25_figs_new/fig4/'
...
plt.tight_layout()
save_individual_figure('fig4a_psychometric')
plt.close()
...
plt.tight_layout()
save_individual_figure('fig4b_rt_quantiles')
plt.close()
...
plt.tight_layout()
save_individual_figure('fig4c_slopes_scatter')
plt.close()
...
plt.tight_layout()
save_individual_figure('fig4d_gamma')
plt.close()
...
print("Combined figure saved: fig4_final_figure.png")
