...
from animal_wise_plotting_utils import prepare_simulation_data, calculate_theoretical_curves, plot_tachometric_curves, plot_grand_summary
from refactored_tied_model_functions import psiam_tied_data_gen_wrapper_rate_norm_fn_refactored, plot_rt_distributions_refactored
...
def compute_loglike_aborts(row, V_A, theta_A, t_A_aff, pdf_trunc_factor):
    ...
    #     raise ValueError('pdf_trunc_factor cannot be 0')
...
######### Vanilla TIED ###############
def compute_loglike_vanilla(row, rate_lambda, T_0, theta_E, Z_E, t_E_aff_slow, t_E_aff_fast, del_go):
...
def vbmc_vanilla_tied_loglike_fn(params):
    rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go = params
    Z_E = (w - 0.5) * 2 * theta_E
    all_loglike = Parallel(n_jobs=30)(delayed(compute_loglike_vanilla)(row, rate_lambda, T_0, theta_E, Z_E, t_E_aff_slow, t_E_aff_fast, del_go)\
...
def vbmc_vanilla_tied_prior_fn(params):
    ...
    t_E_aff_slow_logpdf = trapezoidal_logpdf(
        t_E_aff_slow,
        vanilla_t_E_aff_slow_bounds[0],
        vanilla_t_E_aff_slow_plausible_bounds[0],
        vanilla_t_E_aff_slow_plausible_bounds[1],
        vanilla_t_E_aff_slow_bounds[1]
    )

    t_E_aff_fast_logpdf = trapezoidal_logpdf(
        t_E_aff_fast,
        vanilla_t_E_aff_fast_bounds[0],
        vanilla_t_E_aff_fast_plausible_bounds[0],
        vanilla_t_E_aff_fast_plausible_bounds[1],
        vanilla_t_E_aff_fast_bounds[1]
    )
...
vanilla_t_E_aff_slow_bounds = [0.01, 0.2]
vanilla_t_E_aff_fast_bounds = [0.01, 0.2]
...
vanilla_t_E_aff_slow_plausible_bounds = [0.03, 0.09]
vanilla_t_E_aff_fast_plausible_bounds = [0.03, 0.09]
...
###########  Normalized TIED ##############
def compute_loglike_norm_fn(row, rate_lambda, T_0, theta_E, Z_E, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l):
...
def vbmc_prior_norm_tied_fn(params):
    ...
    t_E_aff_slow_logpdf = trapezoidal_logpdf(
        t_E_aff_slow,
        norm_tied_t_E_aff_slow_bounds[0],
        norm_tied_t_E_aff_slow_plausible_bounds[0],
        norm_tied_t_E_aff_slow_plausible_bounds[1],
        norm_tied_t_E_aff_slow_bounds[1]
    )

    t_E_aff_fast_logpdf = trapezoidal_logpdf(
        t_E_aff_fast,
        norm_tied_t_E_aff_fast_bounds[0],
        norm_tied_t_E_aff_fast_plausible_bounds[0],
        norm_tied_t_E_aff_fast_plausible_bounds[1],
        norm_tied_t_E_aff_fast_bounds[1]
    )
...
norm_tied_t_E_aff_slow_bounds = [0.01, 0.2]
norm_tied_t_E_aff_fast_bounds = [0.01, 0.2]
...
norm_tied_t_E_aff_slow_plausible_bounds = [0.03, 0.09]
norm_tied_t_E_aff_fast_plausible_bounds = [0.03, 0.09]
norm_tied_del_go_plausible_bounds = [0.05, 0.15]
norm_tied_rate_norm_plausible_bounds = [0.8, 0.99]


# Add bounds for all parameters (order: V_A, theta_A, t_A_aff, rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go)
...
############# Time vary norm TIED ##############
def compute_loglike_time_vary_norm_fn(row, rate_lambda, T_0, theta_E, Z_E, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l, bump_height, bump_width, dip_height, dip_width):
...
def vbmc_time_vary_norm_loglike_fn(params):
    rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l, bump_height, bump_width, dip_height, dip_width = params
    Z_E = (w - 0.5) * 2 * theta_E
    all_loglike = Parallel(n_jobs=30)(delayed(compute_loglike_time_vary_norm_fn)(row, rate_lambda, T_0, theta_E, Z_E, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l, bump_height, bump_width, dip_height, dip_width)\
                                       for _, row in df_valid_animal_less_than_1.iterrows() )
    return np.sum(all_loglike)
...
def vbmc_time_vary_norm_prior_fn(params):
    ...
    t_E_aff_slow_logpdf = trapezoidal_logpdf(
        t_E_aff_slow,
        time_vary_norm_tied_t_E_aff_slow_bounds[0],
        time_vary_norm_tied_t_E_aff_slow_plausible_bounds[0],
        time_vary_norm_tied_t_E_aff_slow_plausible_bounds[1],
        time_vary_norm_tied_t_E_aff_slow_bounds[1]
    )

    t_E_aff_fast_logpdf = trapezoidal_logpdf(
        t_E_aff_fast,
        time_vary_norm_tied_t_E_aff_fast_bounds[0],
        time_vary_norm_tied_t_E_aff_fast_plausible_bounds[0],
        time_vary_norm_tied_t_E_aff_fast_plausible_bounds[1],
        time_vary_norm_tied_t_E_aff_fast_bounds[1]
    )
...
time_vary_norm_tied_t_E_aff_slow_bounds = [0.01, 0.2]
time_vary_norm_tied_t_E_aff_fast_bounds = [0.01, 0.2]
...
time_vary_norm_tied_t_E_aff_slow_plausible_bounds = [0.03, 0.09]
time_vary_norm_tied_t_E_aff_fast_plausible_bounds = [0.03, 0.09]
...
# for animal_idx in [0]:
    ...
    pdf_filename = f'results_{batch_name}_animal_{animal}_2tEaff.pdf'
    ...
    w = vp_samples[:, 3].mean()
    Z_E = (w - 0.5) * 2 * theta_E
    t_E_aff_slow = vp_samples[:, 4].mean()
    t_E_aff_fast = vp_samples[:, 5].mean()
    del_go = vp_samples[:, 6].mean()
    ...
    print(f"Z_E           = {Z_E:.5f}")
    print(f"t_E_aff_slow  = {1e3*t_E_aff_slow:.5f} ms")
    print(f"t_E_aff_fast  = {1e3*t_E_aff_fast:.5f} ms")
    print(f"del_go   = {del_go:.5f}")

    vanilla_tied_loglike = vbmc_vanilla_tied_loglike_fn([rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go])
    ...
    save_posterior_summary_page(
        ...
        posterior_means=pd.Series({
            ...
            'w': w,
            'Z_E': Z_E,
            't_E_aff_slow': 1e3*t_E_aff_slow,
            't_E_aff_fast': 1e3*t_E_aff_fast,
            'del_go': del_go
        }),
        param_labels={
            ...
            'w': r'$w$',
            'Z_E': r'$Z_E$',
            't_E_aff_slow': r'$t_{E,slow}^{aff}$',
            't_E_aff_fast': r'$t_{E,fast}^{aff}$',
            'del_go': r'$\Delta_{go}$'
        },
    ...
    vbmc_vanilla_tied_results = {
        ...
        't_E_aff_slow_samples': vp_samples[:, 4],
        't_E_aff_fast_samples': vp_samples[:, 5],
        'del_go_samples': vp_samples[:, 6],
        'message': results['message'],
        'elbo': results['elbo'],
        'elbo_sd': results['elbo_sd'],
    ...
    norm_tied_loglike = vbmc_norm_tied_loglike_fn([rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l])
    save_posterior_summary_page(
        pdf_pages=pdf,
    ...
    vbmc_norm_tied_results = {
        ...
        't_E_aff_fast_samples': vp_samples[:, 5],
        'del_go_samples': vp_samples[:, 6],
        'rate_norm_l_samples': vp_samples[:, 7],
        'message': results['message'],
        'elbo': results['elbo'],
        'elbo_sd': results['elbo_sd'],
    ...
    del_go = vp_samples[:, 6].mean()
    rate_norm_l = vp_samples[:, 7].mean()
    bump_height = vp_samples[:, 8].mean()
    bump_width = vp_samples[:, 9].mean()
    dip_height = vp_samples[:, 10].mean()
    dip_width = vp_samples[:, 11].mean()
    ...
    time_vary_norm_loglike = vbmc_time_vary_norm_loglike_fn([rate_lambda, T_0, theta_E, w, t_E_aff_slow, t_E_aff_fast, del_go, rate_norm_l, bump_height, bump_width, dip_height, dip_width])
    save_posterior_summary_page(
        pdf_pages=pdf,
    ...
    vbmc_time_vary_norm_tied_results = {
        ...
        'del_go_samples': vp_samples[:, 6],
        'rate_norm_l_samples': vp_samples[:, 7],
        'bump_height_samples': vp_samples[:, 8],
        'bump_width_samples': vp_samples[:, 9],
        'dip_height_samples': vp_samples[:, 10],
        'dip_width_samples': vp_samples[:, 11],
        'message': results['message'],
        'elbo': results['elbo'],
        'elbo_sd': results['elbo_sd'],
    ...
    pkl_filename = f'results_{batch_name}_animal_{animal}_2tEaff.pkl'
