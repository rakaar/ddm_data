...
plt.savefig(f'quantile_plot_separate_abls_psycho_fit_{MODEL_TYPE}_{PARAM_SOURCE}.png', dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig(f'quantile_plot_with_errorbars_psycho_fit_{MODEL_TYPE}_{PARAM_SOURCE}.png', dpi=300)
plt.show()