# %%
"""
Assemble a Fig. 2 v2 IPL SVI panel with psychometric slopes as an inset.

Inputs are produced by build_ipl_svi_fig2_v2_data.py in this folder.
This keeps the standard Fig. 2 v2 panel untouched and writes a separate
slopes-inset trial figure.
"""
...
OUTPUT_PNG = SCRIPT_DIR / "figure2_v2_ipl_svi_condition_delay_slopes_inset.png"
OUTPUT_PDF = SCRIPT_DIR / "figure2_v2_ipl_svi_condition_delay_slopes_inset.pdf"
...
INSET_RECT = [0.64, 0.12, 0.31, 0.35]
INSET_LABEL_FONTSIZE = 6.0
INSET_TICK_FONTSIZE = 5.5
INSET_MARKER_SIZE = 12
INSET_LINEWIDTH = 0.8
...
def plot_slopes_inset(parent_ax, data):
    ...
    inset_ax.set_xlabel("Data", fontsize=INSET_LABEL_FONTSIZE, labelpad=0.0)
    inset_ax.set_ylabel("Model", fontsize=INSET_LABEL_FONTSIZE, labelpad=0.0)
    inset_ax.set_xticks([0.1, 0.5, 0.9])
    inset_ax.set_yticks([0.1, 0.5, 0.9])
    inset_ax.set_xlim(0.1, 0.9)
    inset_ax.set_ylim(0.1, 0.9)
    inset_ax.set_aspect("equal", adjustable="box")
    inset_ax.tick_params(axis="both", labelsize=INSET_TICK_FONTSIZE, length=2, pad=1)
    inset_ax.spines["top"].set_visible(False)
    inset_ax.spines["right"].set_visible(False)
    inset_ax.spines["bottom"].set_linewidth(0.7)
    inset_ax.spines["left"].set_linewidth(0.7)
...
def plot_psychometric(ax, data, slopes_data):
    ...
    ax.set_ylabel("P(right)", fontsize=PLOT_LABEL_FONTSIZE)
    ax.set_xlim(-17, 17)
    ...
    plot_slopes_inset(ax, slopes_data)
...
plot_psychometric(ax_psych, psy_data, slopes_data)
