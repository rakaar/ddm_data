...
def get_params_from_animal_pkl_file(batch_name, animal_id):
    ...
    # Fixed t_E_aff and del_go from averaging vanilla and norm tied fits
...
def plot_theoretical_psychometric_data(theoretical_psychometric_data):
    ...
    for i, abl in enumerate(abls):
        ...
        ax.legend()
    plt.tight_layout()
    plt.savefig('theoretical_psychometric_by_abl_4-params-del_E_go_fixed_as_avg.png', dpi=300, bbox_inches='tight')
    plt.show()
    return fig
