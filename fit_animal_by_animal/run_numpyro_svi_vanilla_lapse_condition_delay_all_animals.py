...
# %%
"""
Run vanilla/IPL+lapse condition-delay NumPyro SVI for all 30 animals.
...
FIT_SCRIPT = SCRIPT_DIR / "numpyro_svi_vanilla_lapse_condition_delay_single_animal.py"
ABORT_RESULTS_DIR = REPO_DIR / "aborts_ipl_npl_time_fit_results"
OUTPUT_ROOT = SCRIPT_DIR / "numpyro_svi_vanilla_lapse_condition_delay_patience12_min50k_restore_best_outputs"
...
parser = argparse.ArgumentParser(
    description="Run NumPyro SVI vanilla/IPL+lapse condition-delay fits for all 30 animals."
)
