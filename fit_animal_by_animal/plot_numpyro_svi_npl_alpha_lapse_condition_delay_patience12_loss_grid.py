# %%
"""
Plot all-animal loss curves for the patience12 restore-best NPL+alpha+lapse SVI run.
...
OUTPUT_ROOT = Path(
    os.environ.get(
        "NUMPYRO_NPL_ALPHA_LAPSE_SVI_PATIENCE12_OUTPUT_ROOT",
        str(
            SCRIPT_DIR
...
FIG_PATH = SUMMARY_DIR / "npl_alpha_lapse_condition_delay_patience12_min50k_loss_grid.png"
SUMMARY_CSV = SUMMARY_DIR / "npl_alpha_lapse_condition_delay_patience12_min50k_loss_grid_summary.csv"
...
print("Loaded completed patience12 NPL+alpha+lapse condition-delay SVI runs:")
...
fig.suptitle(
    "Patience12 min-50k restore-best NPL+alpha+lapse condition-delay SVI loss curves",
    y=0.995,
    fontsize=14,
)
