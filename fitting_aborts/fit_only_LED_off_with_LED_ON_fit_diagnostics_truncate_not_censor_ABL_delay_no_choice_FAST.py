...
for abl in supported_abl_values:
    ...
    if normalize_per_abl:
        theory_density_abl_truncated_norm = theory_density_abl_truncated_raw / theory_area_abl_raw
    else:
        theory_density_abl_truncated_norm = theory_density_abl_truncated_raw.copy()
...
fig_abl.suptitle(
    ...
    f"Trials: {abl_counts_str}  |  fixN={'ON' if fix_trial_count_by_abl_from_fit else 'OFF'}",
    y=1.04,
)
