...
def tied_abs_units_decay(ILD_arr, ABL_arr, rate_lambda, theta_E, T_0, t_non_decision, dt, c, c1, max_time=10):
...
def prob_of_hitting_up_in_norm_units(t, ILD, rate_lambda, theta_E, t_non_decision, omega, c, c1, dtau_by_dt):
    chi = 17.37
