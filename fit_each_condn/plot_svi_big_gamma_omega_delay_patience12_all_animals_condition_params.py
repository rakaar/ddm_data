# %%
"""
Plot all-animal condition-parameter means for the patience-12 big SVI rerun.
...
FIG_PATH = GROUP_OUTPUT_DIR / "big_gamma_omega_delay_patience12_all_animals_condition_params.png"
ANIMAL_VALUES_CSV = (
    GROUP_OUTPUT_DIR / "big_gamma_omega_delay_patience12_all_animals_condition_param_animal_values.csv"
)
SUMMARY_CSV = GROUP_OUTPUT_DIR / "big_gamma_omega_delay_patience12_all_animals_condition_param_summary.csv"
...
fig.suptitle("Patience-12 big Gamma/Omega/delay SVI condition parameters averaged across animals", y=1.02)
fig.tight_layout()
