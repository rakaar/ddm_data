...
for cond_ABL in all_ABLs_cond:
    for cond_ILD in all_ILDs_cond:
        ...
        vbmc.save(f'each_cond_data/vbmc_T_vary_only_height_single_condn_ABL_{cond_ABL}_ILD_{cond_ILD}.pkl', overwrite=True)
        ...
        fname = f'each_cond_data/diagnostics_T_vary_only_height_ABL_{cond_ABL}_ILD_{cond_ILD}.png'
