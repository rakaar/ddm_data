...
for animal_id in [103]:
    ...
    # --- PDF output block ---
    pdf_filename = f'{batch_name}_{animal_id}_diagnostics_multiple_gama_omega_at_once_two_w_no_symetry_124816.pdf'
...
#         t_E_aff, w_20, w_60, del_go
    ...
    gamma_ABL_20_ILD_2_samples = vp_samples[:, 2]
    gamma_ABL_20_ILD_minus_2_samples = vp_samples[:, 3]
    gamma_ABL_20_ILD_4_samples = vp_samples[:, 4]
    gamma_ABL_20_ILD_minus_4_samples = vp_samples[:, 5]
    gamma_ABL_20_ILD_8_samples = vp_samples[:, 6]
    gamma_ABL_20_ILD_minus_8_samples = vp_samples[:, 7]
    gamma_ABL_20_ILD_16_samples = vp_samples[:, 8]
    gamma_ABL_20_ILD_minus_16_samples = vp_samples[:, 9]

    gamma_ABL_60_ILD_1_samples = vp_samples[:, 10]
    gamma_ABL_60_ILD_minus_1_samples = vp_samples[:, 11]
    gamma_ABL_60_ILD_2_samples = vp_samples[:, 12]
    gamma_ABL_60_ILD_minus_2_samples = vp_samples[:, 13]
    gamma_ABL_60_ILD_4_samples = vp_samples[:, 14]
    gamma_ABL_60_ILD_minus_4_samples = vp_samples[:, 15]
    gamma_ABL_60_ILD_8_samples = vp_samples[:, 16]
    gamma_ABL_60_ILD_minus_8_samples = vp_samples[:, 17]
    gamma_ABL_60_ILD_16_samples = vp_samples[:, 18]
    gamma_ABL_60_ILD_minus_16_samples = vp_samples[:, 19]

    omega_ABL_20_ILD_1_samples = vp_samples[:, 20]
    omega_ABL_20_ILD_minus_1_samples = vp_samples[:, 21]
    omega_ABL_20_ILD_2_samples = vp_samples[:, 22]
    omega_ABL_20_ILD_minus_2_samples = vp_samples[:, 23]
    omega_ABL_20_ILD_4_samples = vp_samples[:, 24]
    omega_ABL_20_ILD_minus_4_samples = vp_samples[:, 25]
    omega_ABL_20_ILD_8_samples = vp_samples[:, 26]
    omega_ABL_20_ILD_minus_8_samples = vp_samples[:, 27]
    omega_ABL_20_ILD_16_samples = vp_samples[:, 28]
    omega_ABL_20_ILD_minus_16_samples = vp_samples[:, 29]

    omega_ABL_60_ILD_1_samples = vp_samples[:, 30]
    omega_ABL_60_ILD_minus_1_samples = vp_samples[:, 31]
    omega_ABL_60_ILD_2_samples = vp_samples[:, 32]
    omega_ABL_60_ILD_minus_2_samples = vp_samples[:, 33]
    omega_ABL_60_ILD_4_samples = vp_samples[:, 34]
    omega_ABL_60_ILD_minus_4_samples = vp_samples[:, 35]
    omega_ABL_60_ILD_8_samples = vp_samples[:, 36]
    omega_ABL_60_ILD_minus_8_samples = vp_samples[:, 37]
    omega_ABL_60_ILD_16_samples = vp_samples[:, 38]
    omega_ABL_60_ILD_minus_16_samples = vp_samples[:, 39]

    t_E_aff_samples = vp_samples[:, 40]
    w_20_samples = vp_samples[:, 41]
    w_60_samples = vp_samples[:, 42]
    del_go_samples = vp_samples[:, 43]
    ...
    gamma_ABL_20_ILD_minus_2 = gamma_ABL_20_ILD_minus_2_samples.mean()
    ...
    gamma_ABL_20_ILD_minus_8 = gamma_ABL_20_ILD_minus_8_samples.mean()
    ...
    gamma_ABL_60_ILD_minus_2 = gamma_ABL_60_ILD_minus_2_samples.mean()
    ...
    gamma_ABL_60_ILD_minus_8 = gamma_ABL_60_ILD_minus_8_samples.mean()
    ...
    omega_ABL_20_ILD_minus_2 = omega_ABL_20_ILD_minus_2_samples.mean()
    ...
    omega_ABL_20_ILD_minus_8 = omega_ABL_20_ILD_minus_8_samples.mean()
    ...
    omega_ABL_60_ILD_minus_2 = omega_ABL_60_ILD_minus_2_samples.mean()
    ...
    omega_ABL_60_ILD_minus_8 = omega_ABL_60_ILD_minus_8_samples.mean()
    ...
    gamma_ABL_20_ILD_1_samples, gamma_ABL_20_ILD_minus_1_samples, gamma_ABL_20_ILD_2_samples, gamma_ABL_20_ILD_minus_2_samples, gamma_ABL_20_ILD_4_samples, gamma_ABL_20_ILD_minus_4_samples, gamma_ABL_20_ILD_8_samples, gamma_ABL_20_ILD_minus_8_samples, gamma_ABL_20_ILD_16_samples, gamma_ABL_20_ILD_minus_16_samples,
    gamma_ABL_60_ILD_1_samples, gamma_ABL_60_ILD_minus_1_samples, gamma_ABL_60_ILD_2_samples, gamma_ABL_60_ILD_minus_2_samples, gamma_ABL_60_ILD_4_samples, gamma_ABL_60_ILD_minus_4_samples, gamma_ABL_60_ILD_8_samples, gamma_ABL_60_ILD_minus_8_samples, gamma_ABL_60_ILD_16_samples, gamma_ABL_60_ILD_minus_16_samples,
    omega_ABL_20_ILD_1_samples, omega_ABL_20_ILD_minus_1_samples, omega_ABL_20_ILD_2_samples, omega_ABL_20_ILD_minus_2_samples, omega_ABL_20_ILD_4_samples, omega_ABL_20_ILD_minus_4_samples, omega_ABL_20_ILD_8_samples, omega_ABL_20_ILD_minus_8_samples, omega_ABL_20_ILD_16_samples, omega_ABL_20_ILD_minus_16_samples,
    omega_ABL_60_ILD_1_samples, omega_ABL_60_ILD_minus_1_samples, omega_ABL_60_ILD_2_samples, omega_ABL_60_ILD_minus_2_samples, omega_ABL_60_ILD_4_samples, omega_ABL_60_ILD_minus_4_samples, omega_ABL_60_ILD_8_samples, omega_ABL_60_ILD_minus_8_samples, omega_ABL_60_ILD_16_samples, omega_ABL_60_ILD_minus_16_samples,
    ...
    # Print parameter table on first PDF page instead of corner plot
    param_means = [
        gamma_ABL_20_ILD_1, gamma_ABL_20_ILD_minus_1, gamma_ABL_20_ILD_2, gamma_ABL_20_ILD_minus_2, gamma_ABL_20_ILD_4, gamma_ABL_20_ILD_minus_4, gamma_ABL_20_ILD_8, gamma_ABL_20_ILD_minus_8, gamma_ABL_20_ILD_16, gamma_ABL_20_ILD_minus_16,
        gamma_ABL_60_ILD_1, gamma_ABL_60_ILD_minus_1, gamma_ABL_60_ILD_2, gamma_ABL_60_ILD_minus_2, gamma_ABL_60_ILD_4, gamma_ABL_60_ILD_minus_4, gamma_ABL_60_ILD_8, gamma_ABL_60_ILD_minus_8, gamma_ABL_60_ILD_16, gamma_ABL_60_ILD_minus_16,
        omega_ABL_20_ILD_1, omega_ABL_20_ILD_minus_1, omega_ABL_20_ILD_2, omega_ABL_20_ILD_minus_2, omega_ABL_20_ILD_4, omega_ABL_20_ILD_minus_4, omega_ABL_20_ILD_8, omega_ABL_20_ILD_minus_8, omega_ABL_20_ILD_16, omega_ABL_20_ILD_minus_16,
    ...
    fig, ax = plt.subplots(figsize=(10, min(18, 0.4*len(param_labels)+1)))
    ax.axis('off')
    table_data = [(lbl, f"{val:.4f}") for lbl, val in zip(param_labels, param_means)]
    table = ax.table(cellText=table_data, colLabels=["Parameter", "Mean Value"], loc='center', cellLoc='left')
    table.auto_set_font_size(False)
    table.set_fontsize(10)
    table.scale(1, 1.5)
    plt.title(f'Parameter Means\nAnimal: {animal_id}, Batch: {batch_name}', fontsize=14)
    pdf.savefig(fig)
    plt.close(fig)
    ...
    def get_gamma(ABL, ILD):
        if ABL == 20:
            if ILD == 1:
                ...
                return gamma_ABL_20_ILD_minus_2
            elif ILD == 4:
                ...
                return gamma_ABL_20_ILD_minus_8
            elif ILD == 16:
            ...
            if ILD == 1:
                ...
                return gamma_ABL_60_ILD_minus_2
            elif ILD == 4:
    ...
    def get_omega(ABL, ILD):
        if ABL == 20:
            if ILD == 1:
                ...
                return omega_ABL_20_ILD_minus_2
            elif ILD == 4:
            ...
            if ILD == 1:
                ...
                return omega_ABL_60_ILD_minus_2
            elif ILD == 4:
                ...
                return omega_ABL_60_ILD_minus_8
            elif ILD == 16:
