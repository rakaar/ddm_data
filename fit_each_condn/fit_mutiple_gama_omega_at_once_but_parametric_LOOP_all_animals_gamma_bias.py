...
for animal_id in [103]:
    ...
    def compute_loglike_trial(row, g_tanh_scale_20, g_ild_scale_20, g_ild_offset_20, o_ratio_scale_20, o_ild_scale_20, o_ild_offset_20, norm_factor_20,
        ...
        w_20, w_40, w_60, t_E_aff, del_go, g_bias_20, g_bias_40, g_bias_60):
        # data
        c_A_trunc_time = 0.3
        rt = row['timed_fix']
    ...
    def vbmc_prior_fn(params):
        ...
        # g_bias
        logpdf += trapezoidal_logpdf(g_bias_20, g_bias_bounds[0], g_bias_plausible_bounds[0], g_bias_plausible_bounds[1], g_bias_bounds[1])
        logpdf += trapezoidal_logpdf(g_bias_40, g_bias_bounds[0], g_bias_plausible_bounds[0], g_bias_plausible_bounds[1], g_bias_bounds[1])
        logpdf += trapezoidal_logpdf(g_bias_60, g_bias_bounds[0], g_bias_plausible_bounds[0], g_bias_plausible_bounds[1], g_bias_bounds[1])
    ...
    plb = np.array([
        ...
        g_bias_plausible_bounds[0], g_bias_plausible_bounds[0], g_bias_plausible_bounds[0]
    ])
    pub = np.array([
        ...
        g_bias_plausible_bounds[1], g_bias_plausible_bounds[1], g_bias_plausible_bounds[1]
    ])
    ...
    g_bias_20_0 = np.random.uniform(g_bias_plausible_bounds[0], g_bias_plausible_bounds[1])
    g_bias_40_0 = np.random.uniform(g_bias_plausible_bounds[0], g_bias_plausible_bounds[1])
    g_bias_60_0 = np.random.uniform(g_bias_plausible_bounds[0], g_bias_plausible_bounds[1])
    ...
    # %%
    vbmc.save(f'vbmc_mutiple_gama_omega_at_once_but_parametric_batch_{batch_name}_animal_{animal_id}_BETTER_BOUNDS_V2_Gamma_BIAS.pkl', overwrite=True)
