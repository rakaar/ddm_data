...
for cond_ABL in all_ABLs_cond:
    for cond_ILD in all_ILDs_cond:
        ...
        def vbmc_loglike_fn(params):
            ...
            all_loglike = Parallel(n_jobs=30)(delayed(compute_loglike_trial)(row, gamma, omega, t_E_aff, w, del_go) \
                                            for _, row in df_led_off_valid_trials_cond_filtered.iterrows())
        ...
        plb = np.array([gamma_plausible_bounds[0], omega_plausible_bounds[0], t_E_aff_plausible_bounds[0], w_plausible_bounds[0], del_go_plausible_bounds[0]])
        pub = np.array([gamma_plausible_bounds[1], omega_plausible_bounds[1], t_E_aff_plausible_bounds[1], w_plausible_bounds[1], del_go_plausible_bounds[1]])
        ...
        x_0 = np.array([gamma_0, omega_0, t_E_aff_0, w_0, del_go_0])
        ...
        # save vbmc 
        vbmc.save(f'vbmc_cond_by_cond_{batch_name}_{animal_id}_{cond_ABL}_ILD_{cond_ILD}.pkl', overwrite=True)
