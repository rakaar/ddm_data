...
def compute_loglike_trial(row, g_tanh_scale_20, g_ild_scale_20, g_ild_offset_20, o_ratio_scale_20, o_ild_scale_20, o_ild_offset_20, norm_factor_20,
    ...
    if ABL == 20:
        gamma = g_tanh_scale_20 * np.tanh(g_ild_scale_20 * (ILD - g_ild_offset_20)) + g_bias_20
        ...
        gamma = g_tanh_scale_40 * np.tanh(g_ild_scale_40 * (ILD - g_ild_offset_40)) + g_bias_40
        ...
        gamma = g_tanh_scale_60 * np.tanh(g_ild_scale_60 * (ILD - g_ild_offset_60)) + g_bias_60
    ...
    # if omega > 20:
    #     if ABL == 20:
    #         cosh_ratio = np.cosh(o_ild_scale_20 * (ILD - o_ild_offset_20)) / np.cosh(o_ild_scale_20 * norm_factor_20 * (ILD - o_ild_offset_20))
    #         raise ValueError(f"omega is too large for ABL {ABL}, ILD {ILD}, omega={omega}, cosh_ratio={cosh_ratio}, o_ratio_scale_20={o_ratio_scale_20}, o_ild_scale_20={o_ild_scale_20}, o_ild_offset_20={o_ild_offset_20}, norm_factor_20={norm_factor_20}")
    #     elif ABL == 40:
    #         cosh_ratio = np.cosh(o_ild_scale_40 * (ILD - o_ild_offset_40)) / np.cosh(o_ild_scale_40 * norm_factor_40 * (ILD - o_ild_offset_40))
    #         raise ValueError(f"omega is too large for ABL {ABL}, ILD {ILD}, omega={omega}, cosh_ratio={cosh_ratio}, o_ratio_scale_40={o_ratio_scale_40}, o_ild_scale_40={o_ild_scale_40}, o_ild_offset_40={o_ild_offset_40}, norm_factor_40={norm_factor_40}")
    #     elif ABL == 60:
    #         cosh_ratio = np.cosh(o_ild_scale_60 * (ILD - o_ild_offset_60)) / np.cosh(o_ild_scale_60 * norm_factor_60 * (ILD - o_ild_offset_60))
    #         raise ValueError(f"omega is too large for ABL {ABL}, ILD {ILD}, omega={omega}, cosh_ratio={cosh_ratio}, o_ratio_scale_60={o_ratio_scale_60}, o_ild_scale_60={o_ild_scale_60}, o_ild_offset_60={o_ild_offset_60}, norm_factor_60={norm_factor_60}")
...
g_bias_bounds = [-1,1]
g_bias_plausible_bounds = [-0.5,0.5]
...
g_bias_20_bounds = g_bias_40_bounds = g_bias_60_bounds = g_bias_bounds
g_bias_20_plausible_bounds = g_bias_40_plausible_bounds = g_bias_60_plausible_bounds = g_bias_plausible_bounds
...
def vbmc_prior_fn(params):
    ...
    logpdf += trapezoidal_logpdf(g_bias_20, g_bias_20_bounds[0], g_bias_20_plausible_bounds[0], g_bias_20_plausible_bounds[1], g_bias_20_bounds[1])
    logpdf += trapezoidal_logpdf(g_bias_40, g_bias_40_bounds[0], g_bias_40_plausible_bounds[0], g_bias_40_plausible_bounds[1], g_bias_40_bounds[1])
    logpdf += trapezoidal_logpdf(g_bias_60, g_bias_60_bounds[0], g_bias_60_plausible_bounds[0], g_bias_60_plausible_bounds[1], g_bias_60_bounds[1])
...
lb = np.array([
    ...
    g_bias_20_bounds[0], g_bias_40_bounds[0], g_bias_60_bounds[0]
])
ub = np.array([
    ...
    g_bias_20_bounds[1], g_bias_40_bounds[1], g_bias_60_bounds[1]
])
plb = np.array([
    ...
    g_bias_20_plausible_bounds[0], g_bias_40_plausible_bounds[0], g_bias_60_plausible_bounds[0]
])
pub = np.array([
    ...
    g_bias_20_plausible_bounds[1], g_bias_40_plausible_bounds[1], g_bias_60_plausible_bounds[1]
])
...
g_bias_20_0 = np.random.uniform(g_bias_20_plausible_bounds[0], g_bias_20_plausible_bounds[1])
g_bias_40_0 = np.random.uniform(g_bias_40_plausible_bounds[0], g_bias_40_plausible_bounds[1])
g_bias_60_0 = np.random.uniform(g_bias_60_plausible_bounds[0], g_bias_60_plausible_bounds[1])
...
x_0 = np.array([
    ...
    g_bias_20_0, g_bias_40_0, g_bias_60_0
])
# Run VBMC
...
# %%
vbmc.save(f'vbmc_mutiple_gama_omega_at_once_but_parametric_with_gamma_bias.pkl', overwrite=True)
