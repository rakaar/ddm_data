...
for animal_id in [103]:
    ...
    w_20_bounds = [0.2, 0.8]
    w_20_plausible_bounds = [0.3, 0.7]

    w_60_bounds = [0.2, 0.8]
    w_60_plausible_bounds = [0.3, 0.7]
    ...
    def vbmc_prior_fn(params):
        ...
        w_20_logpdf = trapezoidal_logpdf(w_20, w_20_bounds[0], w_20_plausible_bounds[0], w_20_plausible_bounds[1], w_20_bounds[1])
        w_60_logpdf = trapezoidal_logpdf(w_60, w_60_bounds[0], w_60_plausible_bounds[0], w_60_plausible_bounds[1], w_60_bounds[1])
        ...
        return sum(gamma_logpdfs) + sum(omega_logpdfs) + t_E_aff_logpdf + w_20_logpdf + w_60_logpdf + del_go_logpdf
    ...
    # %%
    vbmc.save(f'{batch_name}_{animal_id}_vbmc_mutiple_gama_omega_at_once_ILDs_1_2_4_8_16_w_20_w_60_NO_SYMETRY.pkl', overwrite=True)