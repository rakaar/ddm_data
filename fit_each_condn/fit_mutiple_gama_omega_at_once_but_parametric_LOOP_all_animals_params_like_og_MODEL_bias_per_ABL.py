...
# for animal_id in [103]:
    ...
    # VBMC loglike
    # params:
    # Gamma: theta_E, rate_lambda, ILD_bias_20, ILD_bias_40, ILD_bias_60
    # Omega: o_ratio_scale_20, o_ratio_scale_40, o_ratio_scale_60, norm_factor
    # misc: w, t_E_aff, del_go
    def compute_loglike_trial(row, theta_E, rate_lambda, ILD_bias_20, ILD_bias_40, ILD_bias_60, o_ratio_scale_20, o_ratio_scale_40, o_ratio_scale_60, norm_factor, w, t_E_aff, del_go):
        ...
        if ABL == 20:
            ...
            raise ValueError(f"Invalid ABL: {ABL}")
    ...
    rate_lambda_bounds = [0.001, 0.7]
    rate_lambda_plausible_bounds = [0.1, 0.5]

    ILD_bias_bounds = [-5, 5]
    ILD_bias_plausible_bounds = [-3, 3]
    ...
    ILD_bias_20_bounds = ILD_bias_40_bounds = ILD_bias_60_bounds = ILD_bias_bounds
    ILD_bias_20_plausible_bounds = ILD_bias_40_plausible_bounds = ILD_bias_60_plausible_bounds = ILD_bias_plausible_bounds
    ...
    def vbmc_prior_fn(params):
        ...
        logpdf += trapezoidal_logpdf(theta_E, theta_E_bounds[0], theta_E_plausible_bounds[0], theta_E_plausible_bounds[1], theta_E_bounds[1])
        logpdf += trapezoidal_logpdf(rate_lambda, rate_lambda_bounds[0], rate_lambda_plausible_bounds[0], rate_lambda_plausible_bounds[1], rate_lambda_bounds[1])
        logpdf += trapezoidal_logpdf(ILD_bias_20, ILD_bias_20_bounds[0], ILD_bias_20_plausible_bounds[0], ILD_bias_20_plausible_bounds[1], ILD_bias_20_bounds[1])
        logpdf += trapezoidal_logpdf(ILD_bias_40, ILD_bias_40_bounds[0], ILD_bias_40_plausible_bounds[0], ILD_bias_40_plausible_bounds[1], ILD_bias_40_bounds[1])
        logpdf += trapezoidal_logpdf(ILD_bias_60, ILD_bias_60_bounds[0], ILD_bias_60_plausible_bounds[0], ILD_bias_60_plausible_bounds[1], ILD_bias_60_bounds[1])
        ...
        logpdf += trapezoidal_logpdf(norm_factor, norm_factor_bounds[0], norm_factor_plausible_bounds[0], norm_factor_plausible_bounds[1], norm_factor_bounds[1])
        logpdf += trapezoidal_logpdf(w, w_bounds[0], w_plausible_bounds[0], w_plausible_bounds[1], w_bounds[1])
    ...
    # %%
    lb = np.array([
        theta_E_bounds[0], rate_lambda_bounds[0], ILD_bias_20_bounds[0], ILD_bias_40_bounds[0], ILD_bias_60_bounds[0], o_ratio_scale_20_bounds[0], o_ratio_scale_40_bounds[0], o_ratio_scale_60_bounds[0], norm_factor_bounds[0],
        w_bounds[0],t_E_aff_bounds[0], del_go_bounds[0]
    ])
    ub = np.array([
        theta_E_bounds[1], rate_lambda_bounds[1], ILD_bias_20_bounds[1], ILD_bias_40_bounds[1], ILD_bias_60_bounds[1], o_ratio_scale_20_bounds[1], o_ratio_scale_40_bounds[1], o_ratio_scale_60_bounds[1], norm_factor_bounds[1],
        w_bounds[1],t_E_aff_bounds[1], del_go_bounds[1]
    ])
    plb = np.array([
        theta_E_plausible_bounds[0], rate_lambda_plausible_bounds[0], ILD_bias_20_plausible_bounds[0], ILD_bias_40_plausible_bounds[0], ILD_bias_60_plausible_bounds[0], o_ratio_scale_20_plausible_bounds[0], o_ratio_scale_40_plausible_bounds[0], o_ratio_scale_60_plausible_bounds[0], norm_factor_plausible_bounds[0],
        w_plausible_bounds[0],t_E_aff_plausible_bounds[0], del_go_plausible_bounds[0]
    ])
    pub = np.array([
        theta_E_plausible_bounds[1], rate_lambda_plausible_bounds[1], ILD_bias_20_plausible_bounds[1], ILD_bias_40_plausible_bounds[1], ILD_bias_60_plausible_bounds[1], o_ratio_scale_20_plausible_bounds[1], o_ratio_scale_40_plausible_bounds[1], o_ratio_scale_60_plausible_bounds[1], norm_factor_plausible_bounds[1],
        w_plausible_bounds[1],t_E_aff_plausible_bounds[1], del_go_plausible_bounds[1]
    ])
    ...
    ILD_bias_20_0 = np.random.uniform(ILD_bias_20_plausible_bounds[0], ILD_bias_20_plausible_bounds[1])
    ILD_bias_40_0 = np.random.uniform(ILD_bias_40_plausible_bounds[0], ILD_bias_40_plausible_bounds[1])
    ILD_bias_60_0 = np.random.uniform(ILD_bias_60_plausible_bounds[0], ILD_bias_60_plausible_bounds[1])
    ...
    norm_factor_0 = np.random.uniform(norm_factor_plausible_bounds[0], norm_factor_plausible_bounds[1])
    ...
    x_0 = np.array([
        theta_E_0, rate_lambda_0, ILD_bias_20_0, ILD_bias_40_0, ILD_bias_60_0, o_ratio_scale_20_0, o_ratio_scale_40_0, o_ratio_scale_60_0, norm_factor_0,
        w_0, t_E_aff_0, del_go_0
    ])
    # Run VBMC
    ...
    # %%
    vbmc.save(f'vbmc_mutiple_gama_omega_at_once_but_parametric_batch_{batch_name}_animal_{animal_id}_params_like_og_MODEL_bias_per_ABL.pkl', overwrite=True)
