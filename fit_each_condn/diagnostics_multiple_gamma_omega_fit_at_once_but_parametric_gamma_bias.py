...
for animal_id in [103]:
    ...
    # --- PDF output block ---
    pdf_filename = f'{batch_name}_{animal_id}_diagnostics_multiple_gama_omega_at_once_but_parametric_batch_{batch_name}_animal_{animal_id}_BETTER_BOUNDS_Gamma_BIAS.pdf'
    ...
    corner_samples = np.vstack([
        ...
        g_bias_20_samples, g_bias_40_samples, g_bias_60_samples
    ]).T
