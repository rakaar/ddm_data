...
# %%
def get_animal_RTD_data(df, animal_id, ABL, abs_ILD, bins):
        ...
        for abl in ABL_arr:
            for abs_ild in abs_ILD_arr:
                ...
                bin_centers, rtd_hist, n_trials = get_animal_RTD_data(
                    animal_df, str(animal_id), abl, abs_ild, rt_bins
                )
...
plt.savefig('asd_wt_og_rtds.png')
# save pdf
plt.savefig('asd_wt_og_rtds.pdf')
# plt.
...
plt.savefig('asd_wt_rescaled_rtds.png')
plt.savefig('asd_wt_rescaled_rtds_4.pdf')
