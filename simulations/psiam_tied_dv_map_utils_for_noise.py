...
######################  NO L ############################
def psiam_tied_data_gen_wrapper_noise_change_no_L(V_A, theta_A, ABL_arr, ILD_arr, rate_lambda, T_0, theta_E, Z_E, t_A_aff, t_E_aff, \
                                t_stim_and_led_tuple, new_V_A, new_noise, iter_num, N_print, is_LED_trial, dt):
    ...
    choice, rt, is_act = simulate_psiam_tied_noise_change_no_L(V_A, theta_A, ABL, ILD, rate_lambda, T_0, theta_E, Z_E, t_stim, t_A_aff, t_E_aff, is_LED_trial, t_led, new_V_A, new_noise, dt)
    return {'choice': choice, 'rt': rt, 'is_act': is_act ,'ABL': ABL, 'ILD': ILD, 't_stim': t_stim, 't_led': t_led, 'is_LED_trial': is_LED_trial}

def simulate_psiam_tied_noise_change_no_L(V_A, theta_A, ABL, ILD, rate_lambda, T_0, theta_E, Z_E, t_stim, t_A_aff, t_E_aff, is_LED_trial, t_led , new_V_A, new_noise, dt):
    ...
    new_sigma = np.sqrt(sigma**2 + new_noise**2)
...
##### T0 with noise both change ############################
##Because RT drops faster than accuracy, changing T0 to compensate ####
def psiam_tied_data_gen_wrapper_noise_change_no_L_T0_change(V_A, theta_A, ABL_arr, ILD_arr, rate_lambda, T_0, theta_E, Z_E, t_A_aff, t_E_aff, \
                                t_stim_and_led_tuple, new_V_A, new_noise, T0_factor, iter_num, N_print, is_LED_trial, dt):
    ABL = random.choice(ABL_arr)
    ILD = random.choice(ILD_arr)
    ...
    choice, rt, is_act = simulate_psiam_tied_noise_change_no_L_T0_factor(V_A, theta_A, ABL, ILD, rate_lambda, T_0, theta_E, Z_E, t_stim, t_A_aff, t_E_aff, is_LED_trial, t_led, new_V_A, new_noise, T0_factor, dt)
    return {'choice': choice, 'rt': rt, 'is_act': is_act ,'ABL': ABL, 'ILD': ILD, 't_stim': t_stim, 't_led': t_led, 'is_LED_trial': is_LED_trial}

def simulate_psiam_tied_noise_change_no_L_T0_factor(V_A, theta_A, ABL, ILD, rate_lambda, T_0, theta_E, Z_E, t_stim, t_A_aff, t_E_aff, is_LED_trial, t_led, new_V_A, new_noise, T0_factor, dt):
    AI = 0; DV = Z_E; t = t_A_aff; dB = dt**0.5
